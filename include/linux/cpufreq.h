...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_FRANCOACTIVE)
extern struct cpufreq_governor cpufreq_gov_francoactive;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_francoactive)
